...
if __name__ == "__main__":
    ...
    # ]
    session = [
        '39301E0C-27AA-4876-9D69-708C29C16AAF',
        '88434F1F-9796-4AFD-96D8-B04A6EB0AE27',
        '3E8A32D4-FCAC-4E19-8F62-4E78E66ED88F',
        '28B462CE-5DAD-497A-B797-39D92880CCE8',
        'BD07D5E0-A035-4B40-BEB1-2F2C2D0120A0',
    ]
    run_num = 0
    start_time = time.time()
    while True:
