    ...
    for index, item in enumerate(item_details):
        ...
        if item["check_flag"] == False:
            ...
            if type_app == 'news_data':
                ...
                item['topic'] = call_gpt_4('text_classify',item['title'])
                update_database(filter, collection, item['topic'], 'topic', generator)
...
if __name__ == "__main__":
    ...
    # ]
    session = [
        '16D3C51D-0330-4747-A053-FBB6D44BE10C',
        '1F619DAF-4C37-4D6F-96C9-329ED4D19747',
        '75408B89-E3BC-4F88-A2AD-93A85ADD3DFB',
        '114FC373-D090-447D-B362-3F14E4DD2634',
        '6EB70FC3-0221-4801-AC56-C7F00B3E1EE0',
    ]
    run_num = 0
    start_time = time.time()
    while True:
